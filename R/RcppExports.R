...
get_CCMESH_cpp <- function(vertices, faces, input_truth_nullable = NULL, select_largest = TRUE) {
    .Call(`_DiscreteMorseR_get_CCMESH_cpp`, vertices, faces, input_truth_nullable, select_largest)
}
